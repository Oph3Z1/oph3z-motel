...
$(function() {
    ...
    function UpdateMotel() {
        console.log(motels[CurrentMotel2].Owner)
...
$(document).on("click", ".management-requests", function() {
    ...
    motelroomupgradepricemiddle = data.MiddleUpgradeMone
    $(".motel-management").css("display", "none");
...
SendTransferMotelUI = function(data, seccondta) {
    ...
    $(".sri-text").html(` ${seccondta.firstname + " " + seccondta.lastname} <span>${translate["motel_transfer"]}</span> `)
}
...
$(document).on("click", ".up-menu-cancel-btnrequest", function () {
    MotelManagementFlex = true
    ChanceStyleRequest = false
    selectedStyles2 = []
    middlesectin = false
